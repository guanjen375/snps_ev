...
/*!
 * \file snps_ev_session.h
 * \brief session to manage multiple snps_ev modules
 *
...
/*!
 * \brief session for facilitating snps_ev device interaction
 */
class SNPS_EVSession : public ModuleNode {
 public:
  /*!
  ...
  static ObjectPtr<SNPS_EVSession>& Current();
 ...
 private:
  ...
  std::shared_ptr<SNPS_EVSectionAllocator>
   ...
   */
  std::shared_ptr<SNPS_EVSectionAllocator> GetAllocator(SectionKind kind) {
  ...
  /*!
    ...
    */
  static void EnterWithScope(ObjectPtr<SNPS_EVSession> session);
...
/*! \brief SNPS_EVTVM task for serialization to 32-bit devices */
...
/*! \brief SNPS_EVTVM task for serialization to 64-bit devices */
